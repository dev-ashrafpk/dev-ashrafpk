...
![Header](https://capsule-render.vercel.app/api?type=waving&color=0:0e1011,50:ef6d58,100:3b82f6&height=230&section=header&text=Ashraf%20P&fontSize=70&fontColor=ffffff&fontAlignY=35&desc=Senior%20Software%20Engineer&descSize=20&descAlignY=55&descColor=ffffff&animation=fadeIn)

[![Typing SVG](https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&duration=3000&pause=1000&color=EF6D58&center=true&vCenter=true&multiline=true&repeat=true&width=600&height=70&lines=Full-Stack+%7C+AI+%26+LLM+Integration+%7C+Cloud+Architecture;Building+scalable+enterprise+solutions+that+matter)](https://git.io/typing-svg)
...
- 🔭 Building **AI-powered enterprise applications** with LangGraph, LangChain & multi-agent systems
- 🏗️ Architecting **cloud-native solutions** on Azure & AWS with Kubernetes & Docker
- ⚡ Passionate about **performance optimization**, clean architecture & spec-driven development
- 🌱 Currently exploring **advanced RAG pipelines** and **event-driven microservices**
...
![CI/CD](https://img.shields.io/badge/CI%2FCD-4CAF50?style=flat-square&logoColor=white)
...
| 🚀 Full-Stack Engineering | 🤖 AI & LLM Integration | ☁️ Cloud Architecture |
|:---:|:---:|:---:|
| End-to-end web applications with React, Node.js, Python & TypeScript | LangGraph, LangChain, RAG pipelines, multi-agent systems & smart pricing | Azure, AWS, Docker, Kubernetes & CI/CD automation pipelines |

| 🎨 UI/UX Design | 🔌 API & Platform Development |
|:---:|:---:|
| Pixel-perfect interfaces with modern frameworks, animations & responsive design | RESTful & GraphQL APIs, microservices, event-driven & spec-driven architectures |
...
![Visitors](https://komarev.com/ghpvc/?username=dev-ashrafpk&color=ef6d58&style=flat-square&label=Profile+Views)

</div>

![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:0e1011,50:ef6d58,100:3b82f6&height=120&section=footer)
